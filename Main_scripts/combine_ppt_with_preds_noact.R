...
# Saves a '../processed_data/[s]_comb.Rdata' for each value of s
...
# do heatmap for whole data. Then think how to split NLL calcs - are they by s? If so, can use the Rdatas? Then how to do for lesions
